...
Все тесты должны проходить, даже тесты предыдущих фаз. Если тест не проходит, не зменяй его без разрешения. Когда запрашиваешь разрешение на изменение теста объясни что не так и почему тест нужно изменить.
